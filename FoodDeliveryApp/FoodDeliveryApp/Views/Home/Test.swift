        ...
        ZStack {
                        ...
                        if isExpanded {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                if selectedMode == .per100g {
                                    NutritionInfoView(calories: "96", proteins: "9.8", fats: "1.2", carbs: "11.9")
                                } else {
                                    NutritionInfoView(calories: "120", proteins: "13", fats: "2", carbs: "14.9")
                                }
            ...
            VStack {
                ...
                HStack {
                    ...
                    Spacer()
                  //  CartButton(counter: $counter, title: "В карзину", addedCart: {}, isSelect: true, width: 200, height: 40)
                    Spacer()
                }
...
#Preview {
    ProductDetailViewTest(viewModel: ProductDetailViewModel(products: ProductModel(dict: [
        "offer_price": 100,
