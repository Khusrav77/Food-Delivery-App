...
struct PromoCodeModel: Identifiable, Equatable {
    ...
    init(dict: NSDictionary) {
        ...
        self.minOrderAmount = dict.value(forKey: "min_order_amount") as? Int ?? 0
        self.maxDiscountAmount = dict.value(forKey: "max_discount_amount") as? Int ?? 0
        self.offerPrice = dict.value(forKey: "offer_price") as? Int ?? 0
