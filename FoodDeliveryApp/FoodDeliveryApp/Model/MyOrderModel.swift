...
struct MyOrderModel: Identifiable, Equatable {
    ...
    init(dict: NSDictionary) {
           ...
           self.userPayPrice = dict.value(forKey: "user_pay_price") as? Int ?? 0
           self.discountPrice = dict.value(forKey: "discount_price") as? Int ?? 0
           self.deliverPrice = dict.value(forKey: "deliver_price") as? Int ?? 0
